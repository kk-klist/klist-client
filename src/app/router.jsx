...
export const router = createBrowserRouter([
  { path: '/login', element: <LoginPage /> }, // 하단탭 없는 단독 화면 (인증 담당) — ⚠️ 미연동: 아직 진입점 없음(주소 직접입력만). 첫진입/가드는 인증 담당이 연결
  { path: '/oauth/callback', element: <OAuthCallbackPage /> }, // 하단탭 없는 단독 화면 (인증 담당) — OAuth 로그인 콜백 처리
  { path: '/onboarding', element: <OnboardingPage /> }, // 하단탭 없는 단독 화면 (인증 담당) — 최초 로그인 시 프로필 설정
